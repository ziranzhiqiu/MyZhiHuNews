...
import cn.qiu.json.news.utils.logger.util.ArrayUtil;
import cn.qiu.json.news.utils.logger.util.SystemUtil;
 ...
 * @author Orhan Obut
 */
final class LoggerPrinter implements cn.qiu.json.news.utils.logger.Printer {
   ...
   */
  private static final cn.qiu.json.news.utils.logger.Settings settings = new cn.qiu.json.news.utils.logger.Settings();
   ...
   */
  @Override
  public cn.qiu.json.news.utils.logger.Settings init(String tag) {
    if (tag == null) {
  ...
  @Override
  public cn.qiu.json.news.utils.logger.Settings getSettings() {
    return settings;
  }
